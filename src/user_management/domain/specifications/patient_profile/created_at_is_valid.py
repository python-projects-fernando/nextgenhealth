"""
Specification that validates whether a given created_at timestamp is valid for a PatientProfile.
...
for patient health information (PHI) records.
"""
...
class ValidCreatedAtSpecification(Specification):
    """
    Specification to validate that created_at is a valid timestamp for PatientProfile creation.

    Enforces temporal integrity by rejecting invalid or impossible timestamps.
    Used during PatientProfile aggregate construction to ensure domain invariants are preserved.
    """
